...
def setup_test_open_channel(mocker: pytest_mock.MockerFixture, request: pytest.FixtureRequest):
    request.cls.mock_client = mocker.Mock()
    request.cls.mock_transport = mocker.Mock()
    request.cls.mock_client.get_transport.return_value = request.cls.mock_transport
